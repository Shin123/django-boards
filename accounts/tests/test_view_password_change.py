...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'jonh'
        password = 'secret123'
        user = User.objects.create_user(username=username, email='jonh@gmail.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    '''
    def setUp(self, data={}):
        self.user = User.objects.create_user(username='jonh', email='jonh@gmail.com', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='jonh', password='old_password')
