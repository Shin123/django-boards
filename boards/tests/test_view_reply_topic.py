...
class ReplyTopicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.username = 'john'
        self.password = '123'
        user = User.objects.create_user(username=self.username, email='jonh@gmail.com', password=self.password)
        self.topic = Topic.objects.create(subject='Hello, world', board=self.board, starter=user)
        Post.objects.create(message='Test', topic=self.topic, created_by=user)
